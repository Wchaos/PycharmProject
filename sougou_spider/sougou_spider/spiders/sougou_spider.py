...
from sougou_spider.items import EtaoItem
import sougou_spider.lstData as lstData
...
class etaoSpider(CrawlSpider):
    ...
    link_extractor = {
        'page':  LinkExtractor(allow = '/detail/\d+\.html.+'),
        'page_down':  LinkExtractor(allow = '/shop\?query=.+',),#restrict_xpaths = '//a[@class = "pagination-next"]'
    }
    _x_query = {

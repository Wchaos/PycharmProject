...
def initCookie(rconn, spiderName):
    ...
    print(type(rconn.keys()))
    print(rconn.keys())
    cookieStr = "".join(rconn.keys())
    cookieNum = cookieStr.count("SinaSpider:Cookies")
...
#
#     print(cookies)
#     logger.warning("The num of the cookies is %s" % len(cookies))
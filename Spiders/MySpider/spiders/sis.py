...
class sisSpider(CrawlSpider):
    ...
    cookie = ""
    rules = (
        Rule(LinkExtractor(allow=('/bbs/forum-186-\d*.html')),process_request='request_form',follow=True),
        Rule(LinkExtractor(allow=('/bbs/thread-\d*-1-\d*.html')),process_request='request_thread'),
    )
    custom_settings = {
